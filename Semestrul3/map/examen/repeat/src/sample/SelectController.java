...
public class SelectController {
    ...
    public void initialize(){
        ...
        //IStmt expr9=new ForStmt(new ConstExpr(1),new BooleanExpr("<",new VarExpr("v"),new ConstExpr(5)),new ArithmExpr("+",new VarExpr("v"),new ConstExpr(1)),new PrintStmt(new VarExpr("v")));
        ...
        IStmt expr9 =new CompStmt(new AssignStmt("v",new ConstExpr(0)),new Until(new CompStmt(new PrintStmt(new VarExpr("v")),new AssignStmt("v",new ArithmExpr("+",new VarExpr("v"),new ConstExpr(1)))),new NotExpr("==",new VarExpr("v"),new ConstExpr(3))));
        ExeStack9.add(expr9);
