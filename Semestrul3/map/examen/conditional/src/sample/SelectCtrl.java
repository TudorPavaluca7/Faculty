...
public class SelectCtrl {
    ...
    public void initialize() {
        ...
        IStmt ex3=new CompoundStatement(new AssignStatement("v",new ConstExpression(10)),new CompoundStatement(
                ...
                new PrintStatement(new VarExpression("v")),new PrintStatement(new ReadHeapExpression("a"))))));
        IStmt s1=new CompoundStatement(new AssignStatement("a",new ConstExpression(1)),new AssignStatement("b",new ConstExpression(2)));
        IStmt s2=new CompoundStatement(new CondAss(new VarExpression("a"),new ConstExpression(100),new ConstExpression(200),"c"),new PrintStatement(new VarExpression("c")));
        IStmt s3=new CompoundStatement(new CondAss(new ArithmeticExpression('-',new VarExpression("b"),new ConstExpression(2)),new ConstExpression(100),new ConstExpression(200),"c"),new PrintStatement(new VarExpression("c")));
